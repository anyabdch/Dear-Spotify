var playlists = [
    ...
    {
        img: "qugast.png",
        desc: "My study playlist! Before coming to college, you couldn't pay me money to listen to lyricless music. If it's an acquired taste I've certainly \
    ...
    {
        img: "fa.png",
        desc: "(See the Winter playlist for more context) This is currently my favorite of my seasonal playlists. I grew up in sunny SoCal, so I had never \
                experienced fall colors before coming to Northwestern and I find it genuinely magical. While I'm still a California girl at heart (and would \
                love to work somewhere like Spotify that would enable me to work at an office in my home state), I don't think I could fully leave the \
    ...
    {
        img: "patn.png",
        desc: "Spotify has a knack for bringing people together. I work as an Orientation Leader (we're called Peer Advisers or PAs) at Northwestern, where each \
